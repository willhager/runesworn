...
func update_health_with_poison() -> void :
	if gremlin1Alive:
		gremlin1Health -= enemy_poison_counter
		gremlin1HealthNode.text = "H:" + str(gremlin1Health)
	elif gremlin1Alive:
		gremlin2Health -= enemy_poison_counter
		gremlin2HealthNode.text = "H:" + str(gremlin2Health)
	if gremlin3Alive:
		gremlin3Health -= enemy_poison_counter
		gremlin3HealthNode.text = "H:" + str(gremlin3Health)
	if addToPoison :
